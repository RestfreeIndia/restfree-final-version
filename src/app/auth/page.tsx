  ...
  return (
    <div className="min-h-screen flex flex-col justify-between lg:flex-row bg-transparent">
      ...
      <div className="w-full lg:w-1/2 bg-white/95 dark:bg-slate-900/95 backdrop-blur-lg flex flex-col border-l border-gray-200/50 dark:border-slate-700/50 flex-1">
        {/* Mobile Header */}
        <div className="lg:hidden bg-gradient-to-r from-blue-600 to-emerald-500 text-white p-6 text-center">
          ...
          <h1 className="text-2xl font-bold mb-2">Welcome to Restfree</h1>
          <p className="text-white/90 text-sm">Find and book restrooms near you</p>
        </div>
        ...
        <div className="p-4 lg:p-6">
          <Link 
            href="/"
            className="inline-flex items-center text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium text-sm transition-all duration-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 px-3 py-2 rounded-lg group"
          >
        ...
        <div className="p-4 lg:p-6 flex-1">
          <div className="w-full max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
              ...
              {!isLogin && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 lg:px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 text-base"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm focus:shadow-md text-base"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full pl-10 pr-12 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm focus:shadow-md text-base"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 text-base"
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-emerald-500 hover:from-blue-700 hover:to-emerald-600 text-white py-4 rounded-lg text-lg font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 transform hover:scale-[1.02] relative overflow-hidden group min-h-[48px]"
              >
              ...
              {isLogin && (
                <div className="text-center">
                  <button
                    type="button"
                    className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium text-sm hover:bg-blue-50 dark:hover:bg-blue-900/20 px-4 py-2 rounded-lg transition-all duration-200 min-h-[44px]"
                  >
            ...
            <div className="lg:hidden text-center mt-6">
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                ...
                <button
                  onClick={switchMode}
                  className="ml-2 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-semibold hover:bg-blue-50 dark:hover:bg-blue-900/20 px-3 py-2 rounded-lg transition-all duration-200 min-h-[44px]"
                >
        ...
        <div className="block lg:hidden w-full">
          <div className="w-full bg-gradient-to-t from-blue-200 to-emerald-100 rounded-t-3xl flex flex-col items-center justify-center py-10 shadow-xl">
            <div className="w-16 h-16 flex items-center justify-center bg-white rounded-full shadow-lg mb-4">
              <img src="/darkbacklogo.jpg" alt="Restfree Logo" className="w-16 h-16 rounded-full object-cover" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
              {/* Fallback icon (MapPin) if image is not visible */}
              {/* <MapPin size={36} className="text-blue-500" /> */}
            </div>
            <p className="text-gray-700 text-base font-semibold text-center max-w-xs mb-1">Find, book, and enjoy the best restrooms and services near you.</p>
            <p className="text-emerald-700 text-sm text-center max-w-xs">Restfree makes your journey comfortable and stress-free!</p>
          </div>
        </div>
      </div>
    </div>
