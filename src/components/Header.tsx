...
import { Menu, X, User, Bookmark, Award } from "lucide-react";
...
const Header = () => {
  ...
  const handleProfileClick = () => {
    if (isLoggedIn) {
      // Always open the user menu for all user types
      setShowUserMenu(!showUserMenu);
    } else {
      console.log("Profile clicked - Redirecting to choose-auth page");
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-blue-700 to-emerald-600 hover:from-blue-800 hover:to-emerald-700 text-white px-4 lg:px-6 py-2 rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-105 transform text-sm lg:text-base"
              >
                Merchant
              </Button>
